...
/** 5.选中的下拉类型 */
@property (nonatomic, strong, nullable)NSString *selectFlag;
...
- (instancetype)initWithArrayData:(NSArray<NSString *>*)arrayData delegate:(nullable id)delegate {
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    ...
    [self.toolbar setTitle:[NSString stringWithFormat:@"%@", self.selectedTitle]];
}
...
- (void)selectedOk {
    [self.delegate pickerSingle:self selectedTitle:self.selectedTitle selectFlag:self.selectFlag];
    [self remove];
}
