...
@interface LLWebViewController ()<UIWebViewDelegate,WKNavigationDelegate,WKUIDelegate,UIGestureRecognizerDelegate>
...
- (UIBarButtonItem*)closeBarButtonItem {
    if (!_closeBarButtonItem) {
        ...
        [_closeBarButtonItem setTintColor:[UIColor whiteColor]];
    }
